...
(cl:defclass <BunkerBmsStatus> (roslisp-msg-protocol:ros-message)
  ((SOC
    :reader SOC
    :initarg :SOC
    :type cl:float
...
(cl:defclass BunkerBmsStatus (<BunkerBmsStatus>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <BunkerBmsStatus>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'BunkerBmsStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bunker_msgs-msg:<BunkerBmsStatus> is deprecated: use bunker_msgs-msg:BunkerBmsStatus instead.")))

(cl:ensure-generic-function 'SOC-val :lambda-list '(m))
(cl:defmethod SOC-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:SOC-val is deprecated.  Use bunker_msgs-msg:SOC instead.")
  (SOC m))

(cl:ensure-generic-function 'SOH-val :lambda-list '(m))
(cl:defmethod SOH-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:SOH-val is deprecated.  Use bunker_msgs-msg:SOH instead.")
  (SOH m))

(cl:ensure-generic-function 'battery_voltage-val :lambda-list '(m))
(cl:defmethod battery_voltage-val ((m <BunkerBmsStatus>))
...
(cl:defmethod battery_current-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:battery_current-val is deprecated.  Use bunker_msgs-msg:battery_current instead.")
  (battery_current m))

(cl:ensure-generic-function 'battery_temperature-val :lambda-list '(m))
(cl:defmethod battery_temperature-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:battery_temperature-val is deprecated.  Use bunker_msgs-msg:battery_temperature instead.")
  (battery_temperature m))

(cl:ensure-generic-function 'Alarm_Status_1-val :lambda-list '(m))
(cl:defmethod Alarm_Status_1-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:Alarm_Status_1-val is deprecated.  Use bunker_msgs-msg:Alarm_Status_1 instead.")
  (Alarm_Status_1 m))

(cl:ensure-generic-function 'Alarm_Status_2-val :lambda-list '(m))
(cl:defmethod Alarm_Status_2-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:Alarm_Status_2-val is deprecated.  Use bunker_msgs-msg:Alarm_Status_2 instead.")
  (Alarm_Status_2 m))

(cl:ensure-generic-function 'Warning_Status_1-val :lambda-list '(m))
(cl:defmethod Warning_Status_1-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:Warning_Status_1-val is deprecated.  Use bunker_msgs-msg:Warning_Status_1 instead.")
  (Warning_Status_1 m))

(cl:ensure-generic-function 'Warning_Status_2-val :lambda-list '(m))
(cl:defmethod Warning_Status_2-val ((m <BunkerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bunker_msgs-msg:Warning_Status_2-val is deprecated.  Use bunker_msgs-msg:Warning_Status_2 instead.")
  (Warning_Status_2 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BunkerBmsStatus>) ostream)
  "Serializes a message object of type '<BunkerBmsStatus>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BunkerBmsStatus>) istream)
  "Deserializes a message object of type '<BunkerBmsStatus>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BunkerBmsStatus>)))
  "Returns string type for a message object of type '<BunkerBmsStatus>"
  "bunker_msgs/BunkerBmsStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BunkerBmsStatus)))
  "Returns string type for a message object of type 'BunkerBmsStatus"
  "bunker_msgs/BunkerBmsStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BunkerBmsStatus>)))
  "Returns md5sum for a message object of type '<BunkerBmsStatus>"
  "8825e008639377a676911a7ad9d079ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BunkerBmsStatus)))
  "Returns md5sum for a message object of type 'BunkerBmsStatus"
  "8825e008639377a676911a7ad9d079ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BunkerBmsStatus>)))
  "Returns full string definition for message of type '<BunkerBmsStatus>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BunkerBmsStatus)))
  "Returns full string definition for message of type 'BunkerBmsStatus"
  (cl:format cl:nil "#BMS date~%float64 SOC~%float64 SOH~%float64 battery_voltage~%float64 battery_current~%float64 battery_temperature~%~%#BMS status~%uint8 Alarm_Status_1~%uint8 Alarm_Status_2~%uint8 Warning_Status_1~%uint8 Warning_Status_2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <BunkerBmsStatus>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BunkerBmsStatus>))
  "Converts a ROS message object to a list"
  (cl:list 'BunkerBmsStatus
    (cl:cons ':SOC (SOC msg))
    (cl:cons ':SOH (SOH msg))
